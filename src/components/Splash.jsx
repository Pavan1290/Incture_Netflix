...
export default function Splash({ onDone }) {
  ...
  useEffect(() => { const t = setTimeout(() => { setVisible(false); onDone?.() }, 2600); return () => clearTimeout(t) }, [onDone])
  if (!visible) return null
  return (
    <div className="splash">
      <div className="netflix-container">
        <svg width="867" height="233" viewBox="0 0 867 233" fill="none" xmlns="http://www.w3.org/2000/svg" className="splash-svg">
          <g id="N" className="seg seg1">
          ...
          <path id="I" className="base seg seg6" d="M669.2 0H705.7V214.3L669.2 211.2V0Z" />
          <g id="X" className="seg seg7">
      ...
      <div className="splash-title">PAVAN&apos;s NETFLIX</div>
    </div>
  )
}
